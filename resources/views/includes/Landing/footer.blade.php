<!-- Footer -->
<section id="footer" class="flex items-center justify-between pt-8 pb-8 bg-blue-10">
    <div class="items-center max-w-6xl px-6 mx-auto lg:px-0 md:px-20">
        <div class="grid grid-cols-1 gap-3 md:grid-cols-1 lg:grid-cols-5">
            ...
            <div class="mb-5">
                <h4 class="mb-2 font-bold font-label lg:text-heading-3 text-heading-4">Social Media</h4>
                <ul class="text-gray-900 font-label">
                    <div>
        ...
        <div class="items-center max-w-6xl p-6 px-6 py-2 mx-auto text-center text-gray-900 lg:px-0 md:px-20">
            <span class="text-gray-900 lg:text-heading-4 text-heading-5">© Sea Education 2023</span>
        </div>

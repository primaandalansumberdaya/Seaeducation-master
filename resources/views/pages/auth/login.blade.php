                ...
                <div class="w-full grid-cols-1 gap-4 p-10 lg:grid lg:grid-cols-2">
                    ...
                    <div class="w-full p-2 mx-4 rounded-lg lg:shadow-xl lg:border lg:ml-24 lg:p-10 lg:max-w-md">
                        ...
                        <p class="mb-8 text-center text-gray-400">
                            Lanjutkan pembelajaranmu dengan Sea Education
                        </p>
                        ...
                        <form>
                            ...
                            <div class="mb-10">
                                <label for="username"
                                    class="mb-1 text-xs font-semibold tracking-wide text-gray-800 sm:text-sm">
                                    Email
                                </label>
                            ...
                            <div class="flex items-start justify-between my-6">
                                <div class="flex flex-col">
                                    <label class="flex items-center font-sans font-normal cursor-pointer">
                                        <input type="checkbox" name="rememberMe"
                                            class="styles_container__omzVP text-primary" />
                                        <span class="ml-2 text-sm">Ingat akun saya</span>
                                    </label>
                                    <div class="mt-1 min-h-5"></div>
                                </div>
                                <a class="text-sm font-medium text-amber-500" href="/auth/reset-password">
                                    Lupa Password?
                                </a>
                            </div>
                            ...
                            <p class="text-center text-black-500 mt-7">
                                Belum memiliki akun?
                                <a class="font-medium text-amber-500" href="/register">
                                    Daftar
                                </a>
                            </p>
